...
export const introTexts : introtext ={
    ...
    // resume: "https://drive.google.com/file/d/1SMmLpIJxrZfSeLlJweaNU2FzvpC3co46/view",
    resume: "https://drive.google.com/file/d/1JZ1ZOeMub24j6-Q1YTXsbKNCLN3b0g8h/view",
    // resume: "https://drive.google.com/file/d/1xKdufLDZgCk5M9dEf6mjBJD-MQ8B5QHO/view",
...
const experiences : personal[] = [
    {
        ...
        longerDescription: "My latest internship under **Cloudsine **Pte **Ltd, a mature cybersecurity startup specialising in developing propreitary **AI **security **products. I worked as a Fullstack Engineer primarily involved in backend development, notably improving the end-end response times of various services such as the **PII **detection **service. I wrote my own **custom **PII **detection Go code that supports Regex and NER organic entity classification for Singapore-based data. To further improve performance, I utilised **Bloom **Filters and constructed a custom **guard from Go's **bits-and-blooms that process only **textual **chunks that were **probabilisitically likely to contain **NER **content. This reduced overhead to **slow **NER libraries. Overall, all these cut response times by **5x from **31 seconds to **~6 seconds. Apart from that, I also worked on securing enterprise code through **SCA, **SAST and **IaC configurations scans, rewriting Dockerfile build stages to use **multi-stage builds, **distroless **images that cut down on **>100 **CVEs. Finally, I created scalable, more streamlined **SIEM **monitoring by onboarding **Elastic **Agent sidecars within the **Helmchart **IaC for log collection, and integrated our guardrails to be called over **LiteLLM. Overall, across the 4 months I made good long lasting friendships and greatly honed my skills. I am ever grateful to CloudsineAI for giving me so much exposure to the world of AI security and software development.",
    },
    {
        index : 1,
